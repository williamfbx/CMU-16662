...
def position_control(model, data):
    ...
    desired_joint_positions = np.array(
        [0.683186996507673, 0.3452335158930178, -0.8195164368276641, -2.0759188895342455, -0.1469670600567182, 3.9192133821936697, -2.7850389771292003])
...
if __name__ == "__main__":
    ...
    # np.savetxt('force_vs_time_force_ctrl_static_init.csv', plot, delimiter=',')
    # np.savetxt('force_vs_time_impedance_ctrl_static_init.csv', plot, delimiter=',')
    np.savetxt('force_vs_time_force_ctrl_static_stable.csv', plot, delimiter=',')
    # np.savetxt('force_vs_time_impedance_ctrl_static_stable.csv', plot, delimiter=',')
